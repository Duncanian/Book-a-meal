...
class TestApiEndpoints(unittest.TestCase):
    ...
    def test_user_can_make_an_order(self):
        ...
        response = self.tester.post('/api/v1/meals/', data=meal_data, content_type='application/json')
        self.assertEqual(response.status_code, 200)

        setup = self.tester.post('/api/v1/menu/', data=meal_data, content_type='application/json')
        self.assertEqual(setup.status_code, 200)

        get_menu = self.tester.get('/api/v1/menu/', content_type = 'application/json')
        ...
        make_order = self.tester.post('/api/v1/orders', data=order_data, content_type = 'application/json')
    ...
    def test_user_can_modify_an_order(self):
        ...
        res = self.tester.put('/api/v1/orders/1', data=mod_order, content_type='application/json')
        self.assertEqual(res.status_code, 200)

    def test_caterer_get_all_meal_options(self):
        #test that api can get all books (GET request)
        response1 = self.tester.get('/api/v1/meals/', content_type='application/json')
        self.assertEqual(response1.status_code, 200)
    ...
    '''def test_caterer_can_update_meal_option_by_id(self):
        ...
        res = self.tester.put('/api/v1/meals/1', data=update_data, content_type='application/json')
        self.assertEqual(res.status_code, 200)'''
    ...
    def test_caterer_can_delete_meal_option_by_id(self):
        ...
        res = self.tester.delete('/api/v1/meals/8', content_type='application/json')
        self.assertEqual(res.status_code, 200)
    ...
    def test_caterer_can_get_orders(self):
        res = self.tester.get('/api/v1/orders', content_type='application/json')
        self.assertEqual(res.status_code, 200)
